...
//import kotlinx.android.synthetic.main.activity_car_provider_details_request.*
...
//
//@AndroidEntryPoint
//class CarProviderDetailsRequestActivity : BaseActivity(),
//    RecyclerItemPositionListener<InstallmentType> {
//    override val layoutId: Int
//        get() = R.layout.activity_car_provider_details_request
//
...
//       // viewModel = viewModelFactory.create(CarRequestViewModel::class.java)
//    }
//
...
//            viewModel.createProviderRequest(et_amount.text.toString())
//        }
//
//    }
//
...
//        modalBottomSheet.show(supportFragmentManager, "CarBranchesBottomSheet")
//    }
//
//    fun openPhonesBottomSheet(phoneList: ArrayList<String>) {
//        val modalBottomSheet = CarPhonesBottomSheet(this.phoneList)
//        modalBottomSheet.show(supportFragmentManager, "CarPhonesBottomSheet")
//    }
//
//    private fun back() {
...
//            response.let {
//                startActivity(
//                    intentFor<RequestSubmittedSuccessfullyActivity>(
...
//            tv_reviews.text = providerDetails.reviews.toString() + " " + resources.getString(R.string.reviews) //reviewers
//        }
//    }
//
...
//                rv_tags_service.layoutManager = LinearLayoutManager(context,
