...
import kotlinx.android.synthetic.main.activity_wedding_request.btn_submit
import kotlinx.android.synthetic.main.activity_wedding_request.et_monthly_installment
import kotlinx.android.synthetic.main.activity_wedding_request.et_name
import kotlinx.android.synthetic.main.activity_wedding_request.et_phone
import kotlinx.android.synthetic.main.activity_wedding_request.et_price
import kotlinx.android.synthetic.main.activity_wedding_request.progress_bar
import kotlinx.android.synthetic.main.activity_wedding_request.spinner_installment_plan
import kotlinx.android.synthetic.main.activity_wedding_request.tv_down_payment
import kotlinx.android.synthetic.main.activity_wedding_request.tv_lbl_installment
import kotlinx.android.synthetic.main.activity_wedding_request.tv_lbl_insurance_company
import kotlinx.android.synthetic.main.activity_wedding_request.tv_lbl_insurance_type
import kotlinx.android.synthetic.main.activity_wedding_request.tv_lbl_monthly
import kotlinx.android.synthetic.main.activity_wedding_request.tv_lbl_name
import kotlinx.android.synthetic.main.activity_wedding_request.tv_lbl_price
import kotlinx.android.synthetic.main.dialog_service_added.view.*
import kotlinx.android.synthetic.main.toolbar.*
import org.jetbrains.anko.intentFor


class WeddingRequestFragment : BaseFragment(), AdapterView.OnItemSelectedListener  {
    override val layoutId: Int
        get() = R.layout.fragment_wedding_request
...
//        }
    ...
    @SuppressLint("SetTextI18n")
    private fun setWeddingData() {
        tv_toolbar_title.text=getString(R.string.wedding_request)
        ...
        et_invitees_number.filters = (Constants.DisableDecimalWithMaxLength(4))
    ...
    private fun workingWithDownPayment() {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                if (!price.isNullOrEmpty()){
                    if(!price.contains(",") && !price.contains("..")){
                        ...
                        tv_down_payment.filters = arrayOf(InputFilterMinMax(0, priceInt))
                    }
                }
    ...
    private fun addWeddingTocart() {
        btn_submit.setOnClickListener {
            btn_submit.isEnabled = false

            viewmodel.addCustomWeddingBookingToCart(
                et_name.text.toString(),
                et_phone.text.toString(),
                et_venue.text.toString(),
                et_invitees_number.text.toString(),
    ...
    private fun setServiceAddedDialogData(view: View, dialog: BottomSheetDialog) {
        view.iv_operation_image.setImageResource(R.drawable.ic_wedding) //operation image
        view.tv_service_name.text = et_venue.text
    ...
    override fun observeViewModel() {
        with(viewmodel)
        {
          ...
          //  observe(viewmodel.customOperationResponse, ::handleBookingResponse)
            observe(viewmodel.customWeddingResponse, ::handleCartBookingResponse)
