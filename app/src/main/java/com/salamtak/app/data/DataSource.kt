...
interface DataSource {
    ...
    suspend fun getRefreshToken(): Resource<RefreshTokenResponse>
    ...
    suspend fun register(
        ...
        phone: String,
        email: String,
        image: String, password: String, confirmPassword: String,deviceId: String,
        fcmToken:String
...
//    suspend fun getProfileInfo(): Resource<ProfileResponse>
    ...
    suspend fun setVerified(mailVerified: Boolean, phoneVerified: Boolean)
//    suspend fun saveUserProfile(basicProfile: BasicProfile)
...
//        categoryId: String
   ...
   //health...
    ...
    suspend fun getAllCities(): Resource<SalamtakListResponse<City>>
