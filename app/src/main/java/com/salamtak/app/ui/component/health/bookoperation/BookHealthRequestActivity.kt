...
@AndroidEntryPoint
class BookHealthRequestActivity : BaseActivity(), AdapterView.OnItemSelectedListener,
    RecyclerItemPositionListener<InstallmentType> {
    val viewModelBooking: BookOperationViewModel by viewModels()

    override val layoutId: Int
        get() = R.layout.activity_book_operation_n

    lateinit var installmentTypesAdater: InstallmentTypesAdapter

    override fun initializeViewModel() {
//        viewModelBooking = viewModelFactory.create(BookOperationViewModel::class.java)
...
//        startActivity(intentFor<OperationRequestSubmittedActivity>())
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModelBooking.operationId = intent!!.getStringExtra(Constants.KEY_OPERATION_ITEM)!!
...
//            it.id.toString()
   ...
   private fun showServiceAddedDialog(){
    ...
    private fun setServiceAddedDialogData(view: View, dialog: BottomSheetDialog) {
        ...
        view.tv_price_after.visibility = View.GONE
